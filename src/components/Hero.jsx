        ...
        <div className="w-full flex justify-center items-center gap-10 md:gap-32 flex-wrap pt-10 px-4">
            <div className="flex flex-col items-center md:items-start text-center md:text-left order-2 md:order-1">
                ...
                <p className="text-[1.1rem] md:text-[1.3rem] text-[#c4c4c4] mt-2 md:mt-6">
                    Indian,s largest onine fashion platform
                </p>
                <button className="bg-[#edb730] w-32 p-3 border-none font-semibold mt-8 hover:bg-[darkorange] transition-colors rounded">
                    Shop Now
                </button>
            </div>

            <div className="right-img order-1 md:order-2">
                <img src="/img/hero1.jpg" alt="Fashion Model" className="h-[25rem] md:h-[30rem] object-cover mb-[-4px]" />
            </div>

            <div className="w-full bg-[var(--rich-black)] min-h-[4rem] text-white text-[1.3rem] flex items-center justify-center text-center p-4 order-3">
